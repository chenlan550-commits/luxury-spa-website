            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div key={service.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105 group">
                ...
                <div className="h-48 bg-gradient-to-br from-amber-100 to-amber-200 relative overflow-hidden">
                  ...
                  {service.id === 'B01' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}cranial-lymphatic.png`} 
                      alt={service.name}
                  ...
                  {service.id === 'B02' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}leg-care.png`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'B03' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}luxury-intro.png`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'B04' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}body-sculpting.jpg`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'B05' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}full-body-relaxation.png`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'B06' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}aromatic-moxibustion.jpg`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'B07' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}lymphatic-drainage.jpg`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'B08' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}womb-care.jpg`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'B09' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}breast-body-sculpting.jpg`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'F01' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}facial-whitening.jpg`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  ...
                  {service.id === 'F02' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}facial-care.jpg`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'F03' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}eye-care.png`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
                  {service.id === 'P01' && (
                    <img 
                      src={`${import.meta.env.BASE_URL}pregnancy-spa.png`} 
                      alt={service.name}
                      className="w-full h-full object-cover"
                    />
                  )}
